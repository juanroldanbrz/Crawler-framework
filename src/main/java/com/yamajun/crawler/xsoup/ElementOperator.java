package com.yamajun.crawler.xsoup;
...
public abstract class ElementOperator {
  ...
  public static class AttributeGetter extends ElementOperator {
    ...
    AttributeGetter(String attribute) {
  ...
  public static class Regex extends ElementOperator {
    ...
    Regex(String expr, String attribute) {
      this.attribute = attribute;
      this.pattern = Pattern.compile(expr);
    }

    Regex(String expr, String attribute, int group) {
      this.attribute = attribute;
      this.pattern = Pattern.compile(expr);
      this.group = group;
    }
